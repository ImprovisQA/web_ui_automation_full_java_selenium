...
/**
 * class for logging in as admin user and for validating Map List items.
 * 
 * @author Armen Torunyan
 * 
 */

public class TestLoginAsAdminUser extends LoginBaseTest {
	...
	public void testBody() throws Exception {
		...
		loginValidator.clickOnLoginAsAdminUserTextLink();
